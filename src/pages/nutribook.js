...
import cooking_16x9 from "../images/blog/16x9/cooking.jpg"
  ...
  <Layout>
    ...
    <Figure>
      <picture>
        ...
        />
        <img src={cooking_16x9} alt="Berries" />
      </picture>
    </Figure>
    <Section>
      <H3>Sign up and and start creating!</H3>
      <p>
        In order to start your own recipe collection you have to sign up and
        become part of the community:{" "}
        <button>
          <Link to="/nutribook">Sign up</Link>
        </button>
      </p>
    </Section>
  </Layout>
